        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
				   	<tr>
                        <td>模板名称</td>
                        <td><s:textfield name="ftname" cssClass="InputStyle"></s:textfield></td>
                    </tr>
                    <tr>
                        <td>所用流程</td>
                        
                        <td><s:select list="#pdList" listKey="key" listValue="key" name="procDefKey" cssClass="SelectStyle"></s:select>
						</td>
                    </tr>
                </table>
            </div>
