            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><s:textfield name="jname" cssClass="InputStyle"></s:textfield></td>
                    </tr>
                    <tr>
                        <td>岗位说明</td>
                        <td><s:textarea name="jdescript" cssClass="TextareaStyle"></s:textarea></td>
                    </tr>
                </table>
            </div>
        </div>
